...
(window as any).__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = [
			...
			'#dsh-quota-capsule{display:flex;flex-direction:column;gap:6px;width:272px;max-width:min(272px,calc(100vw - 36px));box-sizing:border-box;padding:10px 12px;border:1px solid var(--dsw-alias-border-l2,rgba(0,0,0,0.08));border-radius:16px;background:var(--dsw-alias-bg-layer-2,rgba(255,255,255,0.85));backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);box-shadow:var(--dsw-shadow-lv2,0 2px 8px rgba(0,0,0,0.04),0 1px 2px rgba(0,0,0,0.02));cursor:pointer;font:inherit;outline:none;user-select:none;touch-action:none;transform:translateY(0);transition:transform 180ms cubic-bezier(0.16,1,0.3,1),box-shadow 180ms ease,background-color 150ms ease,border-color 150ms ease;animation:dsh-quota-capsule-enter 200ms cubic-bezier(0.16,1,0.3,1)}',
			...
			'#dsh-quota-capsule .dsh-capsule-bar-fill.state-ok{background:var(--dsw-static-green-500,#22c55e)}',
			'#dsh-quota-capsule .dsh-capsule-bar-fill.state-warn{background:var(--dsw-static-amber-500,#f59e0b)}',
			'#dsh-quota-capsule .dsh-capsule-bar-fill.state-error{background:var(--dsw-static-red-500,#ef4444)}',
			'#dsh-quota-capsule .dsh-capsule-bar-fill.state-info{background:var(--dsw-static-deepseek-500,#4176e6)}',
			'#dsh-quota-capsule .dsh-capsule-spacer{flex:1;min-width:0}',
			'#dsh-quota-capsule .dsh-capsule-value{flex:0 0 62px;width:62px;text-align:right;font-size:11.5px;font-weight:600;font-variant-numeric:tabular-nums;letter-spacing:-0.01em;white-space:nowrap;color:var(--dsw-alias-label-primary,#1b1b1c);transition:color 150ms ease}',
			'#dsh-quota-capsule .dsh-capsule-value.state-loading{color:var(--dsw-alias-label-secondary,#61666b);font-weight:400}',
			'#dsh-quota-capsule .dsh-capsule-value.state-warn{color:var(--dsw-static-amber-600,var(--dsw-static-amber-500,#d97706))}',
			'#dsh-quota-capsule .dsh-capsule-value.state-error{color:var(--dsw-static-red-500,#ef4444)}',
			'#dsh-quota-capsule .dsh-capsule-detail{padding-left:116px;font-size:10px;line-height:14px;color:var(--dsw-alias-label-secondary,#61666b);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:left}',
			'#dsh-quota-capsule .dsh-capsule-status{font-size:11.5px;font-weight:550;color:var(--dsw-alias-label-secondary,#61666b);white-space:nowrap;text-align:center;width:100%}',
			'#dsh-quota-capsule .dsh-capsule-status.state-error{color:var(--dsw-static-red-500,#ef4444)}',
			...
			'@media (prefers-reduced-motion: reduce){#dsh-quota-capsule,#dsh-quota-card,#dsh-quota-card .dsh-quota-settings,#dsh-quota-card .dsh-setting-section,#dsh-quota-card .dsh-progress-fill,#dsh-quota-card .dsh-quota-icon,#dsh-quota-card .dsh-setting-reset,#dsh-quota-capsule .dsh-capsule-bar-fill,#dsh-quota-capsule .dsh-capsule-label,#dsh-quota-capsule .dsh-capsule-value,#dsh-quota-card .dsh-status-dot,#dsh-quota-card .dsh-setting-toggle-track,#dsh-quota-card .dsh-setting-toggle-thumb,#dsh-quota-card .dsh-setting-seg-btn{animation:none;transition:none;transform:none}}'
		].join("\n");
		...
		function ChatGPTAccount(props) {
			...
			return React.createElement("div", { className: "dsh-setting-sub-section" },
				...
				React.createElement("div", { className: "dsh-setting-row dsh-chatgpt-row", style: { flexDirection: "column", alignItems: "stretch", gap: "6px" } },
					children),
				React.createElement("div", { className: "dsh-setting-row dsh-setting-row-interactive", style: { marginTop: "4px" } },
					React.createElement("label", { className: "dsh-setting-name" }, t("chatgptProxy")),
		...
		function SettingsPanel(props) {
			...
			var visibilityRows = specs.rows.map(function (spec) {
				...
				return React.createElement("div", { key: spec.id, className: "dsh-setting-row dsh-setting-row-interactive" },
					React.createElement("div", { className: "dsh-setting-name-wrap" },
						React.createElement("span", { className: "dsh-setting-name", title: spec.label }, spec.label),
						React.createElement("span", { className: "dsh-setting-badge dsh-setting-badge-" + spec.kind }, badgeText)),
					React.createElement("label", { className: "dsh-setting-toggle", title: spec.label },
						React.createElement("input", {
						...
						React.createElement("span", { className: "dsh-setting-toggle-track" },
							React.createElement("span", { className: "dsh-setting-toggle-thumb" }))));
			});
			...
			var thresholdRows = specs.rows.map(function (spec) {
				...
				return React.createElement("div", { key: spec.id, className: "dsh-setting-row dsh-setting-row-interactive" },
					React.createElement("div", { className: "dsh-setting-name-wrap" },
						React.createElement("span", { className: "dsh-setting-name", title: spec.label }, spec.label),
						React.createElement("span", { className: "dsh-setting-badge dsh-setting-badge-" + spec.kind }, isUsage ? "%" : (spec.currency || "¥"))),
					React.createElement("input", {
			...
			return React.createElement("div", { className: "dsh-quota-settings" },
				...
				React.createElement("div", { className: "dsh-setting-section" },
					...
					React.createElement("div", { className: "dsh-setting-row", style: { marginTop: "6px", flexDirection: "column", alignItems: "stretch", gap: "6px" } },
						React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
							React.createElement("span", { className: "dsh-setting-name" }, t("capsuleName")),
							React.createElement("span", { className: "dsh-setting-hint" }, (settings.capsuleMode || "auto") === "auto" ? t("capsuleAuto") : (settings.capsuleMode === "rolling" ? t("capsuleRolling") : (settings.capsuleMode === "weekly" ? t("capsuleWeekly") : t("capsuleMax"))))),
						React.createElement("div", { className: "dsh-setting-segmented", role: "radiogroup", "aria-label": t("capsuleName") },
				...
				React.createElement("div", { className: "dsh-setting-section" },
					...
					thresholdRows.filter(Boolean).length ? React.createElement("div", { className: "dsh-setting-scroll-list" }, thresholdRows) : null),
				React.createElement("div", { className: "dsh-setting-section" },
					React.createElement("div", { className: "dsh-setting-title" }, t("settingsAdvanced")),
					React.createElement("div", { className: "dsh-setting-row dsh-setting-row-interactive" },
						React.createElement("span", { className: "dsh-setting-name" }, t("panelPosition")),
						React.createElement("button", {
					...
					React.createElement("div", { className: "dsh-setting-sub-section" },
						...
						proxyRows.length ? React.createElement("div", { className: "dsh-setting-scroll-list" }, proxyRows) : null),
