				...
				if (!expanded) {
					...
					if (specs === null && loadError !== null) {
						...
						var pct = typeof topView.barPercent === "number" && Number.isFinite(topView.barPercent)
							...
							: 0;
						pairs.push(React.createElement("span", { key: topRow.id + "-group", className: "dsh-capsule-group" },
							React.createElement("span", {
								key: "ring",
								className: "dsh-capsule-ring state-" + (topView.status || "ok"),
								style: { "--dsh-ring-pct": pct }
							}),
							React.createElement("span", { key: "name", className: "dsh-capsule-name" }, topRow.short || topRow.label),
							React.createElement("span", {
								key: "value",
