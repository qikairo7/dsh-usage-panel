...
`;
        ...
        function HeatmapCard(props) {
            ...
            const levelOf = (v) => (v <= 0 ? 0 : Math.min(4, Math.max(1, Math.ceil((v / maxDay) * 4))));
            ...
            return React.createElement('div', { className: 'dup-card' }, React.createElement('div', { className: 'dup-card-header', style: { justifyContent: 'space-between' } }, React.createElement('span', { className: 'dup-card-title' }, t('heatTitle')), React.createElement('span', { className: 'dup-kpi-sub' }, t('heatWeeks'))), React.createElement('div', { className: 'dup-kpi-sub', style: { marginBottom: 10 } }, t('heatSub')), React.createElement('div', { style: { display: 'flex', gap: 6 } }, React.createElement('div', { style: { width: 26, flex: 'none' } }, React.createElement('div', { style: { display: 'grid', gridTemplateRows: `repeat(7, ${CELL}px)`, gap: GAP } }, wdLabels.map((lbl, i) => React.createElement('div', { key: i, style: { fontSize: 9, color: '#86909C', lineHeight: `${CELL}px` } }, lbl)))), React.createElement('div', null, React.createElement('div', {
                style: {
                    display: 'grid',
                    gridAutoFlow: 'column',
                ...
                return React.createElement('div', { key: col, style: { fontSize: 9, color: '#86909C', whiteSpace: 'nowrap' } }, lbl ? lbl.label : '');
                ...
                if (!c)
                    return React.createElement('div', { key: `e${ci}` });
                ...
                return React.createElement('div', {
                    ...
                    onMouseEnter: (e) => setTip({ row: c, x: e.clientX, y: e.clientY }),
            ...
            })))), React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 4, marginTop: 10, fontSize: 10, color: '#86909C' } }, t('heatMin'), LEVEL.map((c) => React.createElement('i', {
                key: c,
