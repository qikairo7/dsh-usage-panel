                    ...
                    if (specs === null && loadError !== null) {
                        ...
                        for (var j = 0; j < sortedRows.length; j++) {
                            ...
                            var pct = typeof rview.barPercent === "number" && Number.isFinite(rview.barPercent)
                                ...
                                : 0;
                            pairs.push(React.createElement("span", { key: rspec.id + "-group", className: "dsh-capsule-group" }, React.createElement("span", {
                                key: "ring",
                                className: "dsh-capsule-ring state-" + (rview.status || "ok"),
                                style: { "--dsh-ring-pct": pct }
                            }), React.createElement("span", { key: "name", className: "dsh-capsule-name" }, rspec.short || rspec.label), React.createElement("span", {
                                key: "value",
