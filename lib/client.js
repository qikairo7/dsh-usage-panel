...
`;
        ...
        function HeatmapCard(props) {
            ...
            return React.createElement('div', { className: 'dup-card' }, React.createElement('h3', { className: 'dup-card-title', style: { margin: '0 0 16px' } }, t('heatTitle')), React.createElement('div', { className: 'dup-heat-header' }, React.createElement('p', { className: 'dup-kpi-sub' }, t('heatSub', { weeks })), React.createElement('span', { className: 'dup-heat-period' }, t('heatWeeks', { weeks }))), React.createElement('div', { className: 'dup-heat-layout', style: { ['--dup-heat-weeks']: weeks } }, React.createElement('div', { className: 'dup-heat-wd', 'aria-hidden': 'true' }, React.createElement('span', null, t('heatWd1')), React.createElement('span', null, t('heatWd3')), React.createElement('span', null, t('heatWd5'))), React.createElement('div', { className: 'dup-heat-graph', ref: graphRef }, React.createElement('div', { className: 'dup-heat-months', 'aria-hidden': 'true' }, weekStarts.map((key, index) => {
            ...
            })), React.createElement('div', { className: 'dup-heat-grid', role: 'img', 'aria-label': t('heatTitle') }, cells.map((cell) => {
            ...
            })))), React.createElement('div', { className: 'dup-heat-legend' }, React.createElement('span', null, t('heatMin')), [0, 1, 2, 3, 4].map((lv) => React.createElement('span', { key: lv, className: 'dup-heat-swatch', 'data-level': lv })), React.createElement('span', null, t('heatMax'))));
        }
        ...
        function UsageSidebarTab(props) {
            ...
            const loadAllData = React.useCallback((silent = false) => {
                ...
                Promise.all([
                    ...
                    callRpc('timeseries', { range: 'all', bucket: 'day' }),
            ...
            return React.createElement('div', { className: dark ? 'dup-root dup-dark' : 'dup-root', ref: rootRef }, 
