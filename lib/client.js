...
window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        var CSS = [
            ...
            '#dsh-quota-capsule .dsh-capsule-group{display:inline-flex;align-items:center;gap:5px}',
            '#dsh-quota-capsule .dsh-capsule-dot{flex:none;width:6px;height:6px;border-radius:50%;background:var(--dsw-static-neutral-bluish-400,#adb2b8);box-shadow:0 0 0 2px rgba(173,178,184,0.18);transition:background-color 160ms ease,box-shadow 160ms ease}',
            '#dsh-quota-capsule .dsh-capsule-dot.state-ok{background:var(--dsw-static-green-500,#22c55e);box-shadow:0 0 0 2.5px rgba(34,197,94,0.2)}',
            '#dsh-quota-capsule .dsh-capsule-dot.state-warn{background:var(--dsw-static-amber-500,#f59e0b);box-shadow:0 0 0 2.5px rgba(245,158,11,0.22)}',
            '#dsh-quota-capsule .dsh-capsule-dot.state-error{background:var(--dsw-static-red-500,#ef4444);box-shadow:0 0 0 2.5px rgba(239,68,68,0.22)}',
            '#dsh-quota-capsule .dsh-capsule-dot.state-info{background:var(--dsw-static-deepseek-500,#4176e6);box-shadow:0 0 0 2.5px rgba(65,118,230,0.2)}',
            '#dsh-quota-capsule .dsh-capsule-item{font-size:12px;font-weight:550;font-variant-numeric:tabular-nums;letter-spacing:-0.01em;white-space:nowrap;color:var(--dsw-alias-label-primary,#1b1b1c);transition:color 150ms ease}',
            ...
            '#dsh-quota-card .dsh-quota-settings{animation:dsh-quota-settings-fade 180ms ease}',
            '@keyframes dsh-quota-settings-fade{from{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}',
            '#dsh-quota-card .dsh-setting-section{margin-bottom:14px}',
            '#dsh-quota-card .dsh-setting-title{margin-bottom:6px;color:var(--dsw-alias-label-secondary,#61666b);font-size:11px;font-weight:600;line-height:16px;letter-spacing:0.02em}',
            '#dsh-quota-card .dsh-setting-row{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:3.5px 0;color:var(--dsw-alias-label-primary,#1b1b1c);font-size:12.5px;line-height:18px}',
            '#dsh-quota-card .dsh-setting-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
            '#dsh-quota-card .dsh-setting-input,#dsh-quota-card .dsh-setting-select{width:108px;padding:3px 7px;border:1px solid var(--dsw-alias-border-l2,rgba(0,0,0,0.12));border-radius:6px;background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1b1b1c);font:inherit;font-size:11.5px;line-height:16px;box-sizing:border-box;outline:none;transition:border-color 140ms ease,box-shadow 140ms ease}',
            ...
            '#dsh-quota-card .dsh-setting-check{flex:none;width:15px;height:15px;margin:0;cursor:pointer;accent-color:var(--dsw-static-deepseek-500,#4176e6)}',
            ...
            '#dsh-quota-card .dsh-setting-proxy{width:156px}',
            ...
            '@media (prefers-reduced-motion: reduce){#dsh-quota-capsule,#dsh-quota-card,#dsh-quota-card .dsh-quota-settings,#dsh-quota-card .dsh-progress-fill,#dsh-quota-card .dsh-quota-icon,#dsh-quota-card .dsh-setting-reset,#dsh-quota-capsule .dsh-capsule-dot,#dsh-quota-card .dsh-status-dot{animation:none;transition:none;transform:none}}'
        ].join("\n");
        var CAPSULE_CHOICES = [
            { value: "auto" },
            { value: "rolling" },
        ...
        function ChatGPTAccount(props) {
            ...
            return React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, t("chatgptAccount")), React.createElement("div", { className: "dsh-setting-row dsh-chatgpt-row", style: { flexDirection: "column", alignItems: "stretch", gap: "6px" } }, children), React.createElement("div", { className: "dsh-setting-row", style: { marginTop: "4px" } }, React.createElement("label", { className: "dsh-setting-label" }, t("chatgptProxy")), React.createElement("input", {
        ...
        function SettingsPanel(props) {
            ...
            var visibilityRows = specs.rows.map(function (spec) {
                return React.createElement("div", { key: spec.id, className: "dsh-setting-row" }, React.createElement("span", { className: "dsh-setting-name" }, spec.label), React.createElement("input", {
            ...
            var thresholdRows = specs.rows.map(function (spec) {
                ...
                return React.createElement("div", { key: spec.id, className: "dsh-setting-row" }, React.createElement("span", { className: "dsh-setting-name" }, spec.label + (isUsage ? "（%）" : "（" + (spec.currency || "¥") + "）")), React.createElement("input", {
            ...
            return React.createElement("div", { className: "dsh-quota-settings" }, React.createElement(ChatGPTAccount, { key: "chatgpt", t: t, call: call, settings: settings, onChange: onChange }), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, t("settingsProviders")), visibilityRows.length ? visibilityRows : React.createElement("div", { className: "dsh-setting-hint" }, t("settingsNoProviders"))), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, t("settingsInterval")), React.createElement("div", { className: "dsh-setting-row" }, React.createElement("span", { className: "dsh-setting-name" }, t("settingsAutoRefresh")), React.createElement("select", {
            ...
            })))), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, t("settingsCapsule")), React.createElement("div", { className: "dsh-setting-row" }, React.createElement("span", { className: "dsh-setting-name" }, t("capsuleName")), React.createElement("select", {
                className: "dsh-setting-select",
            ...
            })))), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, t("settingsProxy")), React.createElement("div", { className: "dsh-setting-hint", style: { marginBottom: "4px" } }, t("proxyHint")), proxyRows.length ? proxyRows : null), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, t("settingsThresholds")), thresholdRows.filter(Boolean).length ? thresholdRows : null), React.createElement("div", { className: "dsh-setting-actions" }, React.createElement("span", { className: "dsh-setting-hint" }, t("localOnly")), React.createElement("button", { className: "dsh-setting-reset", type: "button", onClick: onReset }, t("resetDefaults"))));
        }
                ...
                if (!expanded) {
                    ...
                    if (specs === null && loadError !== null) {
                        ...
                        for (var j = 0; j < rows.length; j++) {
                            ...
                            pairs.push(React.createElement("span", { key: rspec.id + "-group", className: "dsh-capsule-group" }, React.createElement("span", { key: "dot", className: "dsh-capsule-dot state-" + view.status }), React.createElement("span", {
                                key: "value",
