        ...
        function TimeseriesChart(props) {
            ...
            composed
                ? // Stacked composition: each bar is one bucket, split into
                    ...
                    rows.map((r, i) => {
                        const parts = series.map((s) => ({ ...s, v: r[s.key] ?? 0 }));
                        const total = parts.reduce((a, b) => a + b.v, 0);
                        let cursor = 0;
                        return React.createElement('g', { key: `b${i}` }, parts.map((p) => {
                ...
                : React.createElement('g', null, areaD && React.createElement('path', { d: areaD, fill: 'url(#dup-area-grad)' }), pathD && React.createElement('path', { d: pathD, fill: 'none', stroke: '#007AFF', strokeWidth: 2, strokeLinecap: 'round', strokeLinejoin: 'round' })), 
            // X axis date labels
        ...
        function UsageSidebarTab(props) {
            ...
            React.createElement('div', { className: 'dup-card' }, React.createElement('div', { className: 'dup-card-header' }, React.createElement('span', { className: 'dup-card-title' }, t('breakdownTitle'))), modelBreakdown.length === 0
                ...
                : React.createElement('div', { className: 'dup-table-wrap' }, React.createElement('table', { className: 'dup-table' }, React.createElement('thead', null, React.createElement('tr', null, React.createElement('th', null, t('colModel')), React.createElement('th', null, t('colTokens')), React.createElement('th', null, t('colCost')), React.createElement('th', null, t('colCalls')), React.createElement('th', null, t('colCacheHit')))), React.createElement('tbody', null, modelBreakdown.map((row) => {
                    ...
                    return React.createElement('tr', { key: row.key }, React.createElement('td', { style: { fontWeight: 600 } }, React.createElement('div', null, label), label !== row.key &&
            ...
            !details || details.rows.length === 0
                ...
                : React.createElement('div', { className: 'dup-table-wrap' }, React.createElement('table', { className: 'dup-table' }, React.createElement('thead', null, React.createElement('tr', null, React.createElement('th', null, t('colTimestamp')), React.createElement('th', null, t('colModel')), React.createElement('th', null, t('colOrigin')), React.createElement('th', null, t('colUsageDetail')), React.createElement('th', null, t('colCost')))), React.createElement('tbody', null, details.rows.map((r, idx) => {
                    ...
                    return React.createElement('tr', { key: r.ts + '-' + idx }, React.createElement('td', { style: { whiteSpace: 'nowrap' } }, formatTimestamp(r.ts)), React.createElement('td', null, React.createElement('div', { style: { fontWeight: 600 } }, detailLabel), React.createElement('div', { style: { fontSize: '11px', color: 'var(--dsw-text-tertiary, #86909C)' } }, r.provider || '')), React.createElement('td', null, React.createElement('span', {
                        className: 'dup-badge',
                        style: {
