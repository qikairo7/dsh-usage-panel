                ...
                if (!expanded) {
                    ...
                    if (specs === null && loadError !== null) {
                        ...
                        for (var j = 0; j < visibleRows.length; j++) {
                            ...
                            pairs.push(React.createElement("span", { key: rspec.id + "-group", className: "dsh-capsule-group" }, React.createElement("span", { key: "dot", className: "dsh-capsule-dot state-" + view.status }), React.createElement("span", { key: "name", className: "dsh-capsule-name" }, rspec.short || rspec.label), React.createElement("span", {
                                key: "value",
